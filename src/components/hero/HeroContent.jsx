    ...
    <div className="space-y-7 animate-fade-up">
      ...
      <div>
        ...
        <div className="text-xl md:text-2xl font-medium mt-5 text-muted-foreground">
          <div className="inline-flex items-center w-[220px]">
      ...
      <p className="text-base md:text-lg text-muted-foreground max-w-xl">
        Building modern, interactive web experiences — pixel-pushing layouts,
        buttery motion, and components that feel alive.
      </p>
